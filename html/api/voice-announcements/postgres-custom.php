...
require_once '../models/PostgresVoiceAnnouncement.php';
...
try {
    ...
    // Save to database
    $announcement = new PostgresVoiceAnnouncement();
    $announcement->type = 'custom';
    $announcement->script_text = $prompt;
    $announcement->audio_path = '../uploads/tts/' . $filename;
    ...
    if($announcement->create()) {
        ...
        http_response_code(500);
        echo json_encode(['message' => 'Failed to save announcement to database']);
    }
